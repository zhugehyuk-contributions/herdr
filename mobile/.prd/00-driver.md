...
| M2 읽기 전용 앱 | ✅ + init 전달 수리 (`7c58c49d`) | **✅ 5/5** | **재QA 대기** — 근인 §Y 수리됨(기기 A/B 확증), 판정 미갱신 |
...
1. **iOS M2 (b)(c)(e) 재QA** — 근인(`§Y`)이 **수리됐다**(`7c58c49d`, 기기 A/B: 비배경 0px → 35,153px).
   **(c)는 30분을, (e)는 ≥200컬럼을 실제로 채워야 한다** — 지난 두 회차 모두 미실시다.
   그 뒤 iOS M3(입력)로 간다 — M2 (b)에 막혀 한 번도 못 봤다.
