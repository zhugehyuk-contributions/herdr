...
| M6a 스와이프 리타겟 | ✅ + 근인 수리 `9a256d0a` | **PASS** §FF — 스와이프분 184ms(<200ms), 재연결 0, 양끝 no-op | **FAIL** §JJ — 계측이 답했다: begin 7/7 · start 0/7 · finalize `dx=0 dy=0` = touchesMoved가 0회. 파손은 문서보다 위(네이티브 사슬). **다음 = 제품/하네스 판별 실험** |
