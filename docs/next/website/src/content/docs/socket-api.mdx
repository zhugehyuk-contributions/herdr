...
| Session | `session.snapshot`, `session.list` |
| Remote | `remote.list`, `remote.add`, `remote.remove`, `remote.rename`, `remote.set_enabled`, `remote.set_auto_update`, `remote.set_session` |
