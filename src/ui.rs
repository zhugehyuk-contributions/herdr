...
pub(crate) use self::{
    dialogs::{
        ...
        pairing_qr_popup_rect, remote_manage_confirm_button_rects,
        ...
        render_confirm_delete_worktree_overlay, render_new_session_overlay,
        render_new_workspace_picker_overlay, render_new_worktree_overlay,
        render_pairing_qr_overlay, render_remote_manage_overlay, render_rename_workspace_overlay,
        ...
        AddRemoteOverlayView, ClientMenuRowView, ClientMenuView, DestinationView, PairingQrView,
